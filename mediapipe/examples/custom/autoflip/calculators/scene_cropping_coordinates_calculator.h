...
// Based on scene_cropping_calculator.h
...
#include "mediapipe/examples/custom/autoflip/calculators/scene_cropping_coordinates_calculator.pb.h"
...
// Example config:
// node {
//   calculator: "SceneCroppingCoordinatesCalculator"
...
//   options: {
//     [mediapipe.SceneCroppingCoordinatesCalculatorOptions.ext]: {
//       target_width: 720
//       target_height: 1124
...
class SceneCroppingCoordinatesCalculator : public CalculatorBase {
 public:
 ...
 private:
  ...
  absl::Status InitializeSceneCroppingCoordinatesCalculator(
  ...
  // Calculator options.
  SceneCroppingCoordinatesCalculatorOptions options_;
